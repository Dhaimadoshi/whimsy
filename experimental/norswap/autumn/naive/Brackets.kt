 ...
 */
class Brackets (g: Grammar, val left: String, val right: String, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class Angles (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class Squares (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class Curlies (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class Parens (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class CommaList0 (g: Grammar, val item: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class CommaList1 (g: Grammar, val item: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class CommaListTerm0 (g: Grammar, val item: Parser): Parser()
{
    init { grammar = g }
 ...
 * An additional comma is allowed at the end.
 */
class CommaListTerm1 (g: Grammar, val item: Parser): Parser()
{
    init { grammar = g }
    override fun invoke() = grammar.comma_list1(item)
}
