 ...
 */
class Transact (g: Grammar, val p: ()-> Boolean): Parser()
{
 ...
 */
class IgnoreErrors (g: Grammar, val p: ()-> Boolean): Parser()
{
    init { grammar = g }
 ...
 */
class IgnoreErrorsIfSuccessful (g: Grammar, val p: ()-> Boolean): Parser()
{
    init { grammar = g }
 ...
 * Runs [f] then succeed.
 */
class Perform (g: Grammar, val f: Grammar.() -> Unit): Parser()
{
    init { grammar = g }
 ...
 */
class Log (g: Grammar, val str: String): Parser()
{
    init { grammar = g }
 ...
 */
class Contain (g: Grammar, val failure: () -> String, val p: ()-> Boolean): Parser()
{
    init { grammar = g }
 ...
 */
class TransactContain (g: Grammar, val failure: () -> String, val p: ()-> Boolean): Parser()
{
    init { grammar = g }
 ...
 * [CaughtException].
 */
class Catch (g: Grammar, val p: ()-> Boolean): Parser()
{
    init { grammar = g }
 ...
 */
class CatchContain (g: Grammar, val p: ()-> Boolean): Parser()
{
    init { grammar = g }
 ...
 */
class Inner (g: Grammar, val gather: ()-> Boolean, val refine: (String) -> Boolean): Parser()
{
    init { grammar = g }
 ...
 * to [gobble].
 */
class UntilInner (g: Grammar, val terminator: ()-> Boolean, val refine: (String) -> Boolean): Parser()
{
    init { grammar = g }
