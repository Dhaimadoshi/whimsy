 ...
 */
class Transact (g: Grammar, val p: Parser): Parser()
{
 ...
 */
class IgnoreErrors (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class IgnoreErrorsIfSuccessful (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class Contain (g: Grammar, val failure: () -> String, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class TransactContain (g: Grammar, val failure: () -> String, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 * [CaughtException].
 */
class Catch (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class CatchContain (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class Inner (g: Grammar, val gather: Parser, val refine: (String) -> Boolean): Parser()
{
    init { grammar = g }
 ...
 * to [gobble].
 */
class UntilInner (g: Grammar, val terminator: Parser, val refine: (String) -> Boolean): Parser()
{
    init { grammar = g }
