 ...
 * Always succeeds.
 */
class Maybe (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 * Always suceeds.
 */
class AsBool (g: Grammar, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class AsVal (g: Grammar, val value: Any?, val p: Parser): Parser()
{
    init { grammar = g }
 ...
 */
class Gobble (g: Grammar, val terminator: Parser): Parser()
{
    init { grammar = g }
